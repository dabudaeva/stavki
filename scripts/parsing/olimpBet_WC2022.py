...
from scripts.parsing.split_div_OlympBet import split_list
from scripts.parsing.save_to_csv import save_to_file
"""
from parsing.split_div_OlympBet import split_list
from parsing.save_to_csv import save_to_file
"""

def olimpbet(parsing_date):
    ...
    try:    
        ...
        driver.save_screenshot('./images/OlympBet_world_cup_2022.png')
        ...
        print("some error happen with parsing in olimpBet_WC2022.py!!")