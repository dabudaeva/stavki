...
from scripts.parsing.split_div_LeonBet import split_list
...
def leonbet(parsing_date):
    ...
    try:    
        ...
        driver.save_screenshot('./images/LeonBet_world_cup_2022.png')
        ...
        print("some error happen with parsing in leonBet_WC2022.py!!")